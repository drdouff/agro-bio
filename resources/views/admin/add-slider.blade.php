                      ...
                      <div class="col-lg-6">
                          ...
                          <div class="modal-content cs_modal">
                              <div class="modal-header theme_bg_1 justify-content-center">
                                  <h5 class="modal-title text_white">Ajouter slider</h5>
                              </div>
                              <div class="modal-body">
                                  ...
                                  @endif
                                {!!Form::open(['action' => 'SliderController@sauverslider', 'methode' => 'POST', 'id' => 'commentForm', 'enctype' => 'multipart/form-data'])!!}
                                    {{csrf_field()}}
                                      ...
                                      <div class="form-group">
                                        ...
                                        {{Form::text('description2', '', ['class' => 'form-control', 'id' => 'cprice'])}}
                                      </div>
                                      <div class="form-group">
