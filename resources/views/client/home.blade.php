	  ...
	  <div class="container">
		<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
		  ...
		  <div class="col-sm-12 ftco-animate text-center">
			<h1 class="mb-2">100% Frais &amp; Aliments biologiques</h1>
			<h2 class="subheading mb-4">Nous livrons des légumes bio &amp; fruits</h2>
			<p><a href="#" class="btn btn-primary">Voir les détails</a></p>
		  </div>
	...
	<div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
	  <div class="media block-6 services mb-md-0 mb-4">
		...
		<div class="media-body">
		  ...
		  <span>Sur commande plus $100</span>
		</div>
	  </div>      
	</div>
	<div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
...
<section class="ftco-section">
  ...
  <div class="container">
	...
	<div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
	  ...
	  <span class="price">$10 <a href="#">à présent $5 seulement</a></span>
